SELECT skills AS Skill, ROUND(AVG(j.salary_year_avg),0) AS Pay FROM  
...
WHERE j.job_title_short = 'Data Analyst' AND j.job_location = '' AND j.salary_year_avg IS NOT NULL 
